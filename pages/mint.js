...
export default function Mint() {
  ...
  async function mintInu(how_many_inus) {
    if (inuContract) {
      ...
      const gasAmount = await inuContract.methods
  ...
  return (
    ...
    >
      <Head>
        ...
        <meta
          property="og:url"
          content="https://immortalinu.com/"
          key="ogurl"
        />
        <meta
          property="og:image"
          content="https://immortalinu.com/images/logo.png"
          key="ogimage"
        />
        <meta
