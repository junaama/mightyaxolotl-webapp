      ...
      <div >
          <div className="flex items-center justify-between w-full border-b-2	pb-6">
            ...
            <nav className="flex flex-wrap flex-row justify-around PermanentMarker-Regular">
              ...
              <a href="/#roadmap" className="text-4xl text-white hover:underline m-6">Roadmap</a>
        ...
        <div className="md:w-2/3 w-4/5">
          ...
          <div className="mt-6 border-b-2 py-6">
            ...
            <div className="flex flex-col items-center">
                ...
                <span className="flex PermanentMarker-Regular text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none my-4 ">TOTAL INU'S ADOPTED:  <span className="text-blau text-6xl"> {!signedIn ?  <>-</>  :  <>{totalSupply}</> } / 10000</span></span>
                ...
                <div id="mint" className="flex justify-around  mt-8 mx-6">
                  ...
                  <span className="flex PermanentMarker-Regular text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none px-3 font-bold">INU'S!</span>

                </div>
                {saleStarted ?
                <button onClick={() => mintInu(how_many_inus)} className="mt-4 PermanentMarker-Regular text-4xl border-6 bg-blau  text-white hover:text-black p-2 ">adopt {how_many_inus} inu's for {(inuPrice * how_many_inus) / (10 ** 18)} ETH + GAS</button>
