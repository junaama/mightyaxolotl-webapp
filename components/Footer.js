export default function Footer() {
  return (
      <footer class="bg-white dark:bg-gray-800 w-full  bottom-0">
        <div class="max-w-screen-xl mx-auto">
          ...
          <div class="text-center text-gray-500 dark:text-gray-200 p-4 sm:p-4 font-light flex items-center justify-center">
            2021 © Mighty Axolotl
          </div>
        </div>
      </footer>
